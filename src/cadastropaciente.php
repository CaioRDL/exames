...
<head>
    ...
    <title>Cadastro dos Pacientes</title>
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                        <div class="card-header">
                                                            <h3 class="text-center font-weight-light my-4">Registro do
                                                                Paciente</h3>
                                                        </div>
                                                        <div class="card-body">
                                                            <form action="crud_cadastrocliente.php" method="POST">
                                                                <div class="row mb-3">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-floating mb-3 mb-md-0">
                                                                            <input value="<?php echo @$cadastro_paciente['paciente']; ?>" class="form-control" id="inputname" type="text" placeholder="Digite o nome do Paciente" name="paciente" />
